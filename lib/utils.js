...
export const getTruffleArtifactContractAddress = (artifact) => {
  return fetchNetwork(artifact.networks).address
}

/**
 * We use this function because the networks object
 * can have several networks and we can't guess which network ID
 * the user wants. In this case, we default to the first one detected which
 * has an address property
 */

export const fetchNetwork = (networks) => {
  ...
  alert(
    'We were unable to detect the network of the contract. Are you sure it is deployed?'
  )
  return {}
}

export const blockExplorers = {
  mainnet: { id: 'mainnet', label: 'Mainnet', url: 'https://api.etherscan.io' },
  rinkeby: { id: 'rinkeby', label: 'Rinkeby', url: 'https://api-rinkeby.etherscan.io' },
  // arbitrum: { id: 'arbitrum', label: 'Arbitrum', url: 'https://arbiscan.io' }, // not working due to cors
  // optimism: {
  //   id: 'optimism',
  //   label: 'Optimism',
  //   url: 'https://optimistic.etherscan.io',
  // }, // disabled because of CORS
  other: { id: 'other', label: 'Other', url: 'https://insert-url-here' },
}